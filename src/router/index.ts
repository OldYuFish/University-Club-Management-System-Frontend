      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'detail/:id',
            name: 'club-detail',
            meta: { key: 'club-detail', relation: '111', title: '社团详情', to: '' },
            component: () => import('@/views/club/detail.vue'),
          },
          {
            path: 'apply',
            name: 'club-apply',
            meta: { key: 'club-apply', relation: '112', title: '社团申请', to: '/club/apply'},
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: { key: 'activity-detail', relation: '211', title: '活动详情', to: '' },
            component: () => import('@/views/activity/detail.vue'),
          },
          {
            path: 'apply',
            name: 'activity-apply',
            meta: { key: 'activity-apply', relation: '212', title: '活动申请', to: '/activity/apply' },
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'detail/:id',
            name: 'fund-detail',
            meta: { key: 'fund-detail', relation: '311', title: '经费详情', to: '' },
            component: () => import('@/views/fund/detail.vue'),
          },
          {
            path: 'apply',
            name: 'fund-apply',
            meta: { key: 'fund-apply', relation: '312', title: '经费申请', to: '/fund/apply' },
