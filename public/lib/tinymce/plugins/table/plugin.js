...
;(function () {
    ...
    return cata$2(
      ...
      function (cells) {
        if (cells.length <= 1) {
          ...
          return retrieveBox(table, ephemera.firstSelectedSelector, ephemera.lastSelectedSelector).map(function (
            bounds,
          ) {
            return {
              bounds: bounds,
  ...
  var caretPositionFromPoint = function (doc, x, y) {
    var _a, _b
    return Optional.from(
      (_b = (_a = doc.dom).caretPositionFromPoint) === null || _b === void 0 ? void 0 : _b.call(_a, x, y),
    ).bind(function (pos) {
  ...
  var caretRangeFromPoint = function (doc, x, y) {
    var _a, _b
    return Optional.from(
      (_b = (_a = doc.dom).caretRangeFromPoint) === null || _b === void 0 ? void 0 : _b.call(_a, x, y),
    )
  }
  ...
  var adt$1 = Adt.generate([{ none: ['message'] }, { success: [] }, { failedUp: ['cell'] }, { failedDown: ['cell'] }])
